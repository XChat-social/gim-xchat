...
type ChatRoom struct {
	...
	CreatorName    string    `gorm:"size:50;column:creator_name;not null"`                  // 创建者ID
	UserNum        int32     `gorm:"default:0;not null" json:"user_num"`                    // 当前人数
	OnlineCount    int32     `gorm:"default:0;not null" json:"online_count"`                // 在线人数
	RandomCount    float64   `gorm:"default:1;not null" json:"random_count"`                // 随机数
...
type ChatRoomAndUnreadCount struct {
	...
	RoomID         int64     `gorm:"uniqueIndex;not null" json:"room_id"`
	Name           string    `gorm:"size:50;not null" json:"name"`
	AvatarURL      string    `gorm:"size:255;not null" json:"avatar_url"`
	Introduction   string    `gorm:"size:255;not null" json:"introduction"`
	CreatorId      int64     `gorm:"column:creator_id;not null"`
	UserNum        int32     `gorm:"default:0;not null" json:"user_num"`
	OnlineCount    int32     `gorm:"default:0;not null" json:"online_count"`
	MemberCount    int32     `gorm:"default:0;not null" json:"member_count"`
	MaxMemberCount int32     `gorm:"default:1000;not null" json:"max_member_count"`
	Status         int8      `gorm:"default:1;not null" json:"status"`
	Extra          string    `gorm:"size:1024;default:'';not null" json:"extra"`
	CreateTime     time.Time `gorm:"default:CURRENT_TIMESTAMP;not null" json:"create_time"`
	UpdateTime     time.Time `gorm:"default:CURRENT_TIMESTAMP;not null" json:"update_time"`
	UnreadCount    int64     `gorm:"not null" json:"unread_count"`
	LastMessage    string    `json:"last_message"` // 修改为字符串类型
}
...
type ChatRoomMessage struct {
	...
	LikeCount    int64     `gorm:"not null" json:"like_count"`                                              // 喜欢数量
	DislikeCount int64     `gorm:"not null" json:"dislike_count"`                                           // 不喜欢数量
...
// ChatRoomMessageThumbs 聊天室消息点赞记录
type ChatRoomMessageThumbs struct {
	ID         uint64    `gorm:"primarykey" json:"id"`                                  // 自增主键
	UserID     uint64    `gorm:"not null;index:idx_user_id" json:"user_id"`             // 用户ID
	MessageID  int64     `gorm:"not null" json:"message_id"`                            // 消息ID
	Thumb      int8      `gorm:"not null" json:"thumb"`                                 // 喜欢数量
	CreateTime time.Time `gorm:"default:CURRENT_TIMESTAMP;not null" json:"create_time"` // 创建时间
	UpdateTime time.Time `gorm:"default:CURRENT_TIMESTAMP;not null" json:"update_time"` // 更新时间
}
