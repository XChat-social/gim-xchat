...
var file_connect_ext_proto_rawDesc = []byte{
	...
	0x42, 0x53, 0x43, 0x52, 0x49, 0x42, 0x45, 0x5f, 0x52, 0x4f, 0x4f, 0x4d, 0x10, 0x05, 0x42, 0x1b,
...
func file_connect_ext_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_connect_ext_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Input); i {
			case 0:
				return &v.state
			case 1:
		...
		file_connect_ext_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Output); i {
			case 0:
				return &v.state
			case 1:
		...
		file_connect_ext_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_connect_ext_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_connect_ext_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_connect_ext_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_connect_ext_proto_msgTypes[6].Exporter = func(v any, i int) any {
