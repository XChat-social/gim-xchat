...
func (c *logicExtClient) GetUserChatRooms(ctx context.Context, in *GetUserChatRoomsReq, opts ...grpc.CallOption) (*GetUserChatRoomsResp, error) {
	...
	err := c.cc.Invoke(ctx, LogicExt_GetUserChatRooms_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicExtClient) GetUserCreatedChatRooms(ctx context.Context, in *GetUserCreatedChatRoomsReq, opts ...grpc.CallOption) (*GetUserCreatedChatRoomsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserCreatedChatRoomsResp)
	err := c.cc.Invoke(ctx, LogicExt_GetUserCreatedChatRooms_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogicExt_GetUserChatRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(LogicExtServer).GetUserChatRooms(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LogicExt_GetUserChatRooms_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicExtServer).GetUserChatRooms(ctx, req.(*GetUserChatRoomsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LogicExt_GetUserCreatedChatRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserCreatedChatRoomsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicExtServer).GetUserCreatedChatRooms(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LogicExt_GetUserCreatedChatRooms_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicExtServer).GetUserCreatedChatRooms(ctx, req.(*GetUserCreatedChatRoomsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LogicExt_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LogicExt_GetUserChatRooms_Handler,
		},
		{
