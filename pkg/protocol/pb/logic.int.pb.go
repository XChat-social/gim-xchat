...
const file_logic_int_proto_rawDesc = "" +
	"\n" +
	"\x0flogic.int.proto\x12\x02pb\x1a\x1bgoogle/protobuf/empty.proto\x1a\x0flogic.ext.proto\x1a\x11message.ext.proto\"\x99\x01\n" +
	"\rConnSignInReq\x12\x1b\n" +
	...
	"\tdevice_id\x18\x02 \x01(\x03R\bdeviceId\x12\x10\n" +
	...
	"\rMessageACKReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x1b\n" +
	"\tdevice_id\x18\x02 \x01(\x03R\bdeviceId\x12\x1d\n" +
	"\n" +
	"device_ack\x18\x03 \x01(\x03R\tdeviceAck\x12!\n" +
	"\freceive_time\x18\x04 \x01(\x03R\vreceiveTime\"c\n" +
	"\n" +
	"OfflineReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x1b\n" +
	"\tdevice_id\x18\x02 \x01(\x03R\bdeviceId\x12\x1f\n" +
	"\vclient_addr\x18\x03 \x01(\tR\n" +
	"clientAddr\"\x90\x01\n" +
	"\x10SubscribeRoomReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x1b\n" +
	"\tdevice_id\x18\x02 \x01(\x03R\bdeviceId\x12\x17\n" +
	"\aroom_id\x18\x03 \x01(\x03R\x06roomId\x12\x10\n" +
	"\x03seq\x18\x04 \x01(\x03R\x03seq\x12\x1b\n" +
	"\tconn_addr\x18\x05 \x01(\tR\bconnAddr\"o\n" +
	"\aPushReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\x05R\x04code\x12\x18\n" +
	"\acontent\x18\x03 \x01(\fR\acontent\x12\x1d\n" +
	"\n" +
	"is_persist\x18\x04 \x01(\bR\tisPersist\"\x1c\n" +
	"\bPushResp\x12\x10\n" +
	...
	"\tdevice_id\x18\x01 \x01(\x03R\bdeviceId\"3\n" +
	"\rGetDeviceResp\x12\"\n" +
	"\x06device\x18\x01 \x01(\v2\n" +
	".pb.DeviceR\x06device\"\xde\x02\n" +
	"\x06Device\x12\x1b\n" +
	"\tdevice_id\x18\x01 \x01(\x03R\bdeviceId\x12\x17\n" +
	...
	"\tconn_addr\x18\t \x01(\tR\bconnAddr\x12\x1f\n" +
	"\vclient_addr\x18\n" +
	" \x01(\tR\n" +
	"clientAddr\x12\x1f\n" +
	...
	"updateTime\",\n" +
	"\rServerStopReq\x12\x1b\n" +
	"\tconn_addr\x18\x01 \x01(\tR\bconnAddr2\x87\x04\n" +
	"\bLogicInt\x127\n" +
	"\n" +
	"ConnSignIn\x12\x11.pb.ConnSignInReq\x1a\x16.google.protobuf.Empty\x12!\n" +
	"\x04Sync\x12\v.pb.SyncReq\x1a\f.pb.SyncResp\x127\n" +
	"\n" +
	"MessageACK\x12\x11.pb.MessageACKReq\x1a\x16.google.protobuf.Empty\x121\n" +
	"\aOffline\x12\x0e.pb.OfflineReq\x1a\x16.google.protobuf.Empty\x12=\n" +
	"\rSubscribeRoom\x12\x14.pb.SubscribeRoomReq\x1a\x16.google.protobuf.Empty\x12!\n" +
	"\x04Push\x12\v.pb.PushReq\x1a\f.pb.PushResp\x123\n" +
	"\bPushRoom\x12\x0f.pb.PushRoomReq\x1a\x16.google.protobuf.Empty\x121\n" +
	"\aPushAll\x12\x0e.pb.PushAllReq\x1a\x16.google.protobuf.Empty\x120\n" +
	"\tGetDevice\x12\x10.pb.GetDeviceReq\x1a\x11.pb.GetDeviceResp\x127\n" +
	"\n" +
	"ServerStop\x12\x11.pb.ServerStopReq\x1a\x16.google.protobuf.EmptyB\x1bZ\x19gim-xchat/pkg/protocol/pbb\x06proto3"
