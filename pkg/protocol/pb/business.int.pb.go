...
var file_business_int_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x69, 0x6d, 0x2d, 0x78, 0x63, 0x68,
...
func file_business_int_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_business_int_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_business_int_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_business_int_proto_msgTypes[2].Exporter = func(v any, i int) any {
