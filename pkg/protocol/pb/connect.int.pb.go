...
var file_connect_int_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x69, 0x6d, 0x2d, 0x78, 0x63, 0x68, 0x61, 0x74,
...
func file_connect_int_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_connect_int_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_connect_int_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_connect_int_proto_msgTypes[2].Exporter = func(v any, i int) any {
