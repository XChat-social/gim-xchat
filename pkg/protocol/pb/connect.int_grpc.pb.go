...
func (c *connectIntClient) DeliverMessage(ctx context.Context, in *DeliverMessageReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ConnectInt_DeliverMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedConnectIntServer must be embedded to have
...
func (UnimplementedConnectIntServer) testEmbeddedByValue()                    {}
...
func RegisterConnectIntServer(s grpc.ServiceRegistrar, srv ConnectIntServer) {
	// If the following call pancis, it indicates UnimplementedConnectIntServer was
